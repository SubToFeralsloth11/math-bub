...
const lengthAndPerimeter: Lesson = {
  ...
  learnCards: [
    {
      ...
      body: [
        t("The perimeter is the total distance around the outside of a shape. To find it, add all side lengths together."),
        t("For a rectangle with length l and width w:"),
        m("P = 2l + 2w \\quad \\text{or} \\quad P = 2(l + w)"),
        t("For a square with side length s:"),
        m("P = 4s"),
        t("Always include units (cm, m, km) in your final answer. Make sure all side lengths use the same unit before adding."),
      ],
    },
    {
      id: "4a-worked",
      ...
      body: [
        ...
        t("Always write the formula first, substitute the numbers, then calculate."),
      ],
    },
    {
      id: "4a-mistake",
      ...
      body: [
        t("A common mistake is adding only the visible sides or mixing up length and width."),
        t("For a rectangle, make sure you add all four sides. Another common mistake is confusing perimeter (length around) with area (space inside)."),
        t("Perimeter is measured in linear units (cm, m); area is measured in square units (cm², m²)."),
      ],
    },
  ],
  practice: [
    ...
    },
    {
      ...
      explanation: [
        ...
        t("Work backwards: subtract the known length contribution, then divide by 2."),
      ],
      xp: 10,
      options: [
        { id: "a", label: [t("5")] },
    ...
    },
    {
      id: "4a-p5",
      type: "shortText",
      prompt: [t("A rectangle is 15 m long and 8 m wide. What is its perimeter? Give the number with units.")],
      explanation: [
    ...
    },
    {
      id: "4a-p6",
      type: "numeric",
      prompt: [t("A regular pentagon has sides of 6 cm. What is its perimeter, in cm?")],
      explanation: [
        m(String.raw`P = 5 \times 6 = 30 \text{ cm}`),
        t("A regular pentagon has five equal sides. Multiply the side length by 5."),
      ],
      xp: 15,
      accepted: ["30"],
      unit: "cm",
    },
    {
      id: "4a-p7",
      type: "shortText",
      prompt: [t("A rectangle has perimeter 56 cm and width 12 cm. What is its length? Give a number with units.")],
      explanation: [
    ...
    },
    {
      id: "4a-p9",
      type: "numeric",
      prompt: [t("A rectangular field is 85 m long and 47 m wide. What is the perimeter of the field, in m?")],
      explanation: [
  ...
  mastery: [
    ...
    },
    {
      id: "4a-m2",
      type: "numeric",
      prompt: [t("A rectangle has perimeter 72 cm. Its length is 20 cm. What is its width, in cm?")],
      explanation: [
    ...
    },
    {
      id: "4a-m3",
      type: "mcq",
      prompt: [t("A rectangle's length is three times its width. The perimeter is 64 cm. What is the width?")],
      explanation: [
    ...
    },
    {
      id: "4a-m4",
      type: "numeric",
      prompt: [t("An L-shaped figure is formed from two rectangles: one is 10 cm by 4 cm, the other is 6 cm by 5 cm, joined along the 4 cm side. What is the perimeter of the L-shape, in cm?")],
      explanation: [
        t("Tracing around the outside: start at top-left. Go right 10 cm, down 5 cm, right 6 cm, down 4 cm, left 16 cm (back to left edge), up 9 cm."),
        m(String.raw`P = 10 + 5 + 6 + 4 + 16 + 9 = 50 \text{ cm}`),
        t("Alternatively, the L-shape outside path is equivalent to the perimeter of the bounding 16 cm × 9 cm rectangle."),
      ],
      xp: 20,
      accepted: ["50"],
      unit: "cm",
  ...
  learnCards: [
    {
      ...
      body: [
        ...
        m("C = 2\\pi r"),
        m(String.raw`\pi \approx 3.14 \quad (\text{or use the } \pi \text{ button on your calculator})`),
        t("Always round your answer to 2 decimal places unless the question says otherwise."),
      ],
    },
    {
      id: "4b-worked",
      ...
      body: [
        ...
        m(String.raw`C = 2 \times 3.14 \times 7 = 6.28 \times 7 = 43.96 \text{ cm}`),
    ...
    },
    {
      ...
      body: [
        t("If you know the circumference and need the radius, rearrange the formula:"),
        m(String.raw`r = \frac{C}{2\pi}`),
        t("For example, if C = 31.4 cm and π ≈ 3.14:"),
        m(String.raw`r = \frac{31.4}{2 \times 3.14} = \frac{31.4}{6.28} = 5 \text{ cm}`),
  ...
  practice: [
    ...
    },
    {
      ...
      explanation: [
        ...
        t("When given the diameter, use C = πd directly - no need to find the radius first."),
      ],
      xp: 10,
      accepted: ["31.4"],
      unit: "cm",
    },
    {
      ...
      explanation: [
        m(String.raw`C = 2 \times 3.14 \times 3.5 = 6.28 \times 3.5 = 21.98 \text{ cm}`),
      ],
      xp: 10,
      accepted: ["21.98"],
      unit: "cm",
    },
    {
      id: "4b-p4",
      type: "mcq",
      prompt: [t("If you double the radius of a circle, what happens to its circumference?")],
      explanation: [
        t("Circumference is directly proportional to radius:"),
        m("C = 2\\pi r"),
        t("If r becomes 2r, then C becomes 2π(2r) = 4πr = 2C. So the circumference doubles."),
      ],
      xp: 10,
      options: [
    ...
    },
    {
      ...
      explanation: [
        ...
        t("One rotation covers a distance equal to the circumference. Convert to metres: 219.8 cm = 2.198 m."),
      ],
      xp: 15,
      template: [
        t("A bicycle wheel has radius 35 cm. In one full rotation it travels ___ cm. (Use π ≈ 3.14)"),
      ],
      accepted: ["219.8"],
    },
    {
      ...
      type: "shortText",
      prompt: [
        t("The circumference of a circle is proportional to its radius. What is the constant of proportionality? Write the Greek letter or its name."),
      ],
      explanation: [
        t("From C = 2πr, the constant of proportionality is 2π. This is approximately 6.28."),
        t("When a quantity y is proportional to x (y = kx), the constant k is the ratio y/x. Here k = C/r = 2π."),
      ],
      xp: 15,
    ...
    },
    {
      ...
      prompt: [t("Complete the sentence.")],
      explanation: [
        t("From C = πd: d = 94.2 ÷ 3.14 = 30 cm."),
      ],
      xp: 15,
      template: [
        t("A circle has a circumference of 94.2 cm. Its diameter is ___ cm. (Use π ≈ 3.14)"),
      ],
      accepted: ["30"],
    },
    {
      ...
      explanation: [
        t("C = πd, so circumference equals π times diameter. C = 2πr, so circumference equals 2π times radius."),
        t("The first option is incorrect (π × radius gives half the circumference). The third is incorrect (π is about 3.14, not 2). The fourth is nonsense."),
      ],
      xp: 15,
      options: [
        { id: "a", label: [t("C = πr (circumference equals π times radius)")] },
        { id: "b", label: [t("C = πd (circumference equals π times diameter)")] },
    ...
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A circular garden bed has circumference 47.1 m. What is its radius? Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 1 dp."),
      ],
      explanation: [
        m(String.raw`r = \frac{47.1}{2 \times 3.14} = \frac{47.1}{6.28} = 7.5 \text{ m}`),
        t("Divide the circumference by 2π to find the radius. Check: 2 × 3.14 × 7.5 = 47.1."),
      ],
      xp: 20,
      accepted: ["7.5"],
      unit: "m",
  ...
  mastery: [
    {
      ...
      explanation: [
        m(String.raw`C = 3.14 \times 14 = 43.96 \text{ m}`),
      ],
      xp: 15,
      accepted: ["43.96"],
      unit: "m",
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A circular running track has circumference 314 m. What is its diameter? Use"),
        m(String.raw`\pi \approx 3.14`),
        t("."),
      ],
      explanation: [
    ...
    },
    {
      ...
      type: "mcq",
      prompt: [
        t("Circle A has radius 4 cm. Circle B has radius 8 cm. How many times larger is the circumference of Circle B? Use"),
        m(String.raw`\pi \approx 3.14`),
        t("."),
      ],
      explanation: [
        ...
        t("Ratio: 50.24 ÷ 25.12 = 2. When you double the radius, you double the circumference."),
      ],
      xp: 15,
      options: [
    ...
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A semicircle (half a circle) has a straight edge of 10 cm (this is its diameter). What is the perimeter of the semicircle, including the straight edge? Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 2 dp."),
      ],
      explanation: [
        ...
        t("The perimeter of a closed shape includes all boundary edges - the arc and the diameter."),
      ],
      xp: 20,
      accepted: ["25.7"],
      unit: "cm",
  ...
  learnCards: [
    {
      ...
      body: [
        t("Area measures the space inside a flat shape. It is measured in square units (cm², m², km²)."),
        ...
        t("The height must be perpendicular (at right angles) to the base. You can choose any side as the base - just make sure you use the height measured from that base."),
      ],
    },
    {
      id: "4c-worked-rect",
    ...
    },
    {
      ...
      body: [
        t("A triangle has base 10 cm and perpendicular height 6 cm. Find its area."),
        m(String.raw`A = \frac{1}{2} \times 10 \times 6 = 5 \times 6 = 30 \text{ cm}^2`),
        t("The ½ and the base multiply first (giving 5), then multiply by height."),
      ],
    },
  ],
  practice: [
    {
      id: "4c-p1",
      type: "numeric",
      prompt: [t("A rectangle is 12 cm long and 5 cm wide. What is its area, in cm²?")],
      explanation: [
        m(String.raw`A = 12 \times 5 = 60 \text{ cm}^2`),
      ],
      xp: 10,
    ...
    },
    {
      id: "4c-p2",
      type: "numeric",
      prompt: [t("A triangle has base 10 cm and perpendicular height 6 cm. What is its area, in cm²?")],
      explanation: [
    ...
    },
    {
      ...
      explanation: [
        ...
        t("If b becomes 2b, then A becomes ½(2b)h = bh = 2 × (½bh). So the area doubles."),
      ],
      xp: 10,
      options: [
        { id: "a", label: [t("It doubles")] },
    ...
    },
    {
      id: "4c-p7",
      type: "shortText",
      prompt: [t("A rectangle is 6 m long and 4 m wide. What is its area? Give the number with units.")],
      explanation: [
        m(String.raw`A = 6 \times 4 = 24 \text{ m}^2`),
      ],
      xp: 15,
    ...
    },
    {
      ...
      prompt: [t("Complete the sentence.")],
      explanation: [
        m(String.raw`A = \frac{1}{2} \times (6 + 10) \times 4 = \frac{1}{2} \times 16 \times 4 = 32 \text{ cm}^2`),
        t("A trapezium's area is half the sum of the parallel sides multiplied by the perpendicular height."),
      ],
      xp: 15,
      template: [
        t("A trapezium has parallel sides 6 cm and 10 cm, with perpendicular height 4 cm. Its area is ___ cm²."),
      ],
      accepted: ["32"],
    },
    {
      id: "4c-p9",
      type: "numeric",
      prompt: [t("A rectangular garden bed is 5.5 m long and 3.2 m wide. What is its area, in m²? Give your answer to 1 dp.")],
      explanation: [
    ...
    },
    {
      id: "4c-p10",
      type: "mcq",
      prompt: [t("A rectangle's length is doubled and its width is halved. What happens to its area?")],
      explanation: [
    ...
    },
    {
      id: "4c-p11",
      type: "numeric",
      prompt: [t("A right-angled triangle has legs of 9 cm and 12 cm (these form the right angle). What is its area, in cm²?")],
      explanation: [
        t("In a right-angled triangle, the two legs are perpendicular. Use one as base and the other as height:"),
  ...
  mastery: [
    {
      id: "4c-m1",
      type: "numeric",
      prompt: [t("A rectangle has area 96 cm² and length 12 cm. What is its width, in cm?")],
      explanation: [
    ...
    },
    {
      id: "4c-m2",
      type: "numeric",
      prompt: [t("A triangle has area 45 cm² and base 15 cm. What is its perpendicular height, in cm?")],
      explanation: [
        m(String.raw`45 = \frac{1}{2} \times 15 \times h`),
        m(String.raw`45 = 7.5h \implies h = \frac{45}{7.5} = 6 \text{ cm}`),
        t("Double the area and divide by base: h = (2 × 45) ÷ 15 = 90 ÷ 15 = 6."),
      ],
      xp: 15,
      accepted: ["6"],
      unit: "cm",
    },
    {
      id: "4c-m3",
      type: "mcq",
      prompt: [t("Triangle T has base 8 cm and height 5 cm. Triangle U has base 4 cm and height 10 cm. How do their areas compare?")],
      explanation: [
        t("Triangle T:"),
    ...
    },
    {
      id: "4c-m4",
      type: "numeric",
      prompt: [t("A parallelogram has base 12 cm and perpendicular height 7 cm. Its area formula is A = b × h (same as a rectangle). What is its area, in cm²?")],
      explanation: [
        m(String.raw`A = 12 \times 7 = 84 \text{ cm}^2`),
        t("A parallelogram's area is base × perpendicular height. The slanted sides do not affect the area - only the perpendicular distance between the parallel sides matters."),
      ],
      xp: 20,
      accepted: ["84"],
    },
...
const areaOfCircles: Lesson = {
  ...
  learnCards: [
    ...
    },
    {
      ...
      body: [
        t("A very common mistake is using the diameter instead of the radius in A = πr²."),
        t("If the diameter is 10 cm, the radius is 5 cm. Using d = 10 directly gives A = π × 10² = π × 100 ≈ 314 cm², which is four times the correct answer."),
        t("Correct: r = 5 cm, A = π × 5² = π × 25 ≈ 78.5 cm²."),
        t("Always check: are you using the radius or the diameter? The formula uses r, not d."),
      ],
    },
  ],
  practice: [
    ...
    },
    {
      ...
      explanation: [
        t("Radius = 12 ÷ 2 = 6 cm."),
        m(String.raw`A = 3.14 \times 6^2 = 3.14 \times 36 = 113.04 \text{ cm}^2`),
      ],
      xp: 10,
      accepted: ["113.04"],
    },
    {
      ...
      explanation: [
        m(String.raw`A = 3.14 \times 3.5^2 = 3.14 \times 12.25 = 38.465 \approx 38.47 \text{ cm}^2`),
        t("3.5² = 3.5 × 3.5 = 12.25. Then 3.14 × 12.25 = 38.465, rounded to 38.47."),
      ],
      xp: 10,
    ...
    },
    {
      ...
      explanation: [
        t("If r doubles to 2r, then (2r)² = 4r². The area becomes π × 4r² = 4πr², which is 4 times the original area."),
        t("Because area depends on r², doubling the radius quadruples the area."),
      ],
      xp: 10,
      options: [
    ...
    },
    {
      id: "4e-p7",
      type: "shortText",
      prompt: [t("What happens to the area of a circle if you triple the radius? Write your answer as a number followed by 'times'.")],
      explanation: [
    ...
    },
    {
      ...
      type: "mcq",
      prompt: [
        t("Circle P has radius 4 cm. Circle Q has radius 12 cm. How many times larger is the area of Circle Q?"),
      ],
      explanation: [
  ...
  mastery: [
    {
      ...
      explanation: [
        t("Radius = 16 ÷ 2 = 8 cm."),
        m(String.raw`A = 3.14 \times 8^2 = 3.14 \times 64 = 200.96 \text{ cm}^2`),
      ],
      xp: 15,
      accepted: ["200.96"],
    },
    ...
    },
    {
      id: "4e-m3",
      type: "mcq",
      prompt: [t("A circle and a square have the same perimeter of 40 cm. Which has the larger area? Use π ≈ 3.14.")],
      explanation: [
        t("Square: side = 40 ÷ 4 = 10 cm, area = 10² = 100 cm²."),
        t("Circle: C = 2πr = 40, so r = 40 ÷ 6.28 ≈ 6.37 cm. Area = π × 6.37² ≈ 127.4 cm²."),
        t("For a given perimeter, a circle encloses more area than any other shape. The circle wins."),
      ],
      xp: 20,
      options: [
  ...
  learnCards: [
    {
      ...
      body: [
        t("A sector is a slice of a circle, like a pizza slice. Its area is a fraction of the full circle's area."),
    ...
    },
    {
      ...
      body: [
        ...
        t("Strategy: split the shape into rectangles, triangles, circles, or semicircles. Find each individual area, then add (or subtract) them."),
        t("For shapes with holes or cutouts, subtract the cutout area from the larger shape."),
    ...
    },
    {
      ...
      body: [
        t("An L-shape can be split into two rectangles: a 10 cm by 4 cm rectangle on top, and a 6 cm by 5 cm rectangle on the bottom."),
        t("Top rectangle: A = 10 × 4 = 40 cm²."),
        t("Bottom rectangle: A = 6 × 5 = 30 cm²."),
        t("Total area: 40 + 30 = 70 cm²."),
        t("Do not double-count the overlapping region - make sure you split cleanly along a boundary."),
      ],
    },
  ],
  practice: [
    {
      ...
      explanation: [
        ...
        t("A quarter circle is a sector with θ = 90°, which is 1/4 of the full circle."),
      ],
      xp: 10,
      accepted: ["12.56"],
    },
    {
      ...
      explanation: [
        m(String.raw`A = \frac{60}{360} \times 3.14 \times 6^2 = \frac{1}{6} \times 3.14 \times 36 = 3.14 \times 6 = 18.84 \text{ cm}^2`),
        t("60° is 1/6 of a full circle. Simpler to compute as (3.14 × 36) ÷ 6 = 113.04 ÷ 6 = 18.84."),
      ],
      xp: 10,
      accepted: ["18.84"],
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A shape consists of a 10 cm by 6 cm rectangle with a semicircle of diameter 6 cm attached to one of the 6 cm sides. Find the total area. Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 2 dp."),
      ],
      explanation: [
        ...
        m(String.raw`\text{Semicircle area} = \frac{1}{2} \times 3.14 \times 9 = 14.13 \text{ cm}^2`),
    ...
    },
    {
      id: "4f-p4",
      type: "mcq",
      prompt: [t("What is the best method to find the area of an L-shaped figure?")],
      explanation: [
        t("Split the L-shape into two non-overlapping rectangles, find each area, and add them."),
        t("Alternatively, find the area of the bounding rectangle and subtract the missing rectangular corner. Both methods give the same result."),
      ],
      xp: 10,
      options: [
        { id: "a", label: [t("Split into two rectangles and add their areas")] },
        { id: "b", label: [t("Use the formula for a triangle")] },
        { id: "c", label: [t("Multiply the longest side by the shortest side")] },
    ...
    },
    {
      ...
      explanation: [
        m(String.raw`A = \frac{120}{360} \times 3.14 \times 25 = \frac{1}{3} \times 78.5 = 26.17 \text{ cm}^2`),
        t("120° is one third of 360°. Full circle area: 78.5. One third: 26.17 (rounded)."),
      ],
      xp: 15,
    ...
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A composite shape is made from a 12 cm by 8 cm rectangle, with a quarter circle of radius 4 cm cut out from one corner. Find the remaining area. Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 2 dp."),
      ],
      explanation: [
    ...
    },
    {
      id: "4f-p7",
      type: "shortText",
      prompt: [t("A composite shape is formed by joining a triangle and a semicircle. The triangle has base 8 cm and height 6 cm. The semicircle sits on the base and has diameter 8 cm. Which basic area formulas do you need? List them.")],
      explanation: [
        t("You need the triangle area formula (A = ½bh) and the circle area formula (A = πr²), then halve the circle result for the semicircle."),
        t("Triangle: ½ × 8 × 6 = 24 cm². Semicircle: ½ × π × 4² = ½ × 3.14 × 16 = 25.12 cm². Total: 49.12 cm²."),
      ],
      xp: 15,
      accepted: ["triangle and circle", "triangle formula and circle formula", "½bh and πr²", "1/2bh and πr2", "triangle, circle"],
    },
    {
      id: "4f-p8",
      type: "fillInTheBlank",
      prompt: [t("Complete the sentence.")],
      explanation: [
        t("Outer: 3.14 × 25 = 78.5. Inner: 3.14 × 9 = 28.26. Ring area: 78.5 - 28.26 = 50.24 cm²."),
      ],
      xp: 15,
      template: [
        t("An annulus (flat ring) has outer radius 5 cm and inner radius 3 cm. Its area is ___ cm². (Use π ≈ 3.14)"),
      ],
      accepted: ["50.24"],
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A running track has two straight sides of 100 m each, and two semicircular ends each of radius 31.83 m. Find the area enclosed by the track. Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to the nearest whole m²."),
      ],
      explanation: [
        t("The track encloses a rectangle (100 m × 63.66 m) plus two semicircles (together making one full circle of r = 31.83 m)."),
    ...
    },
    {
      id: "4f-p10",
      type: "mcq",
      prompt: [t("A sector with angle 45° is what fraction of the full circle?")],
      explanation: [
  ...
  mastery: [
    {
      ...
      explanation: [
        m(String.raw`A = \frac{150}{360} \times 3.14 \times 100 = \frac{5}{12} \times 314`),
        m(String.raw`= \frac{1570}{12} = 130.83 \text{ cm}^2`),
        t("Full circle: 314 cm². Fraction: 150/360 = 5/12. 314 × 5 ÷ 12 = 130.83."),
      ],
      xp: 15,
      accepted: ["130.83"],
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("A composite shape is a 15 cm by 10 cm rectangle with a semicircle of diameter 10 cm cut from one of the longer sides, curving inward. Find the remaining area. Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 2 dp."),
      ],
      explanation: [
    ...
    },
    {
      ...
      type: "numeric",
      prompt: [
        t("An annulus has outer radius 8 cm and inner radius 5 cm. Find its area. Use"),
        m(String.raw`\pi \approx 3.14`),
        t("and round to 2 dp."),
      ],
      explanation: [
    ...
    },
    {
      id: "4f-m4",
      type: "mcq",
      prompt: [t("A shape is made of a square of side 10 cm, with a quarter circle of radius 10 cm in one corner. The quarter circle area is:")],
      explanation: [
...
const perimeterAreaChallengeQuestions: Question[] = [
  {
    ...
    explanation: [
      t("Find radius first:"),
      m(String.raw`r = \frac{62.8}{2 \times 3.14} = \frac{62.8}{6.28} = 10 \text{ cm}`),
      m(String.raw`A = 3.14 \times 10^2 = 3.14 \times 100 = 314 \text{ cm}^2`),
      t("When given circumference, always find the radius first before computing area."),
    ],
    xp: 20,
    accepted: ["314"],
  },
  {
    ...
    type: "numeric",
    prompt: [
      t("A running track has two straight sides of 100 m each, and two semicircular ends each of radius 31.83 m. Find the perimeter of the track, rounded to the nearest metre. Use"),
      m(String.raw`\pi \approx 3.14`),
      t("."),
    ],
    explanation: [
      t("Two straight sides: 2 × 100 = 200 m."),
      t("Two semicircles form one full circle: C = 2 × 3.14 × 31.83 ≈ 199.89 m."),
  ...
  },
  {
    ...
    type: "numeric",
    prompt: [
      t("A composite shape consists of a right-angled triangle (base 12 cm, height 5 cm) and a semicircle of diameter 5 cm attached to the height side. Find the total area. Use"),
      m(String.raw`\pi \approx 3.14`),
      t("and round to 2 dp."),
    ],
    explanation: [
      ...
      m(String.raw`\frac{1}{2} \times 3.14 \times (2.5)^2 = \frac{1}{2} \times 3.14 \times 6.25 = 9.8125 \text{ cm}^2`),
  ...
  },
  {
    id: "pa-boss-q4",
    type: "mcq",
    prompt: [t("A square and a circle have the same perimeter of 40 units. Which has the larger area, and by how much? Use π ≈ 3.14.")],
    explanation: [
      t("Square: side = 40 ÷ 4 = 10. Area = 10² = 100 square units."),
      t("Circle: C = 2πr = 40 → r = 40 ÷ 6.28 ≈ 6.369. Area = π × 6.369² ≈ 127.4 square units."),
      t("The circle's area is about 27% larger. For any given perimeter, the circle encloses the maximum possible area."),
    ],
    xp: 20,
    options: [
  ...
  },
  {
    ...
    type: "numeric",
    prompt: [
      t("A composite shape is made from a 20 cm by 10 cm rectangle with two identical quarter circles (radius 5 cm each) cut from two adjacent corners. Find the remaining area. Use"),
      m(String.raw`\pi \approx 3.14`),
      t("."),
    ],
    explanation: [
      ...
      m(String.raw`\frac{1}{2} \times 3.14 \times 5^2 = \frac{1}{2} \times 3.14 \times 25 = 39.25 \text{ cm}^2`),
      t("Remaining area: 200 - 39.25 = 160.75 cm²."),
      t("When two cutouts are quarter circles of the same radius on adjacent corners, their total is a half circle."),
    ],
    xp: 20,
    accepted: ["160.75"],
  },
